...
If you don't have these identifiers yet, ask your funder or `search activities on d-portal <https://d-portal.iatistandard.org/>`_. You can include your funder's name and organisation type initially, then add identifiers at a later date.
...
Also list yourself (your org, role = "Accountable" or "Implementing") and any downstream partners you fund.
   

.. topic:: 3) Add incoming fund or commitment transactions
   
   Reference your funder's activity identifier in the 'provider-org' element of each transaction.
